      ...
      <div className="carousel">
        <div className="carousel-indicators">
          <button
            type="button"
            data-slide-to="0"
            className={activeIndex === 0 ? "active" : ""} onClick={handlePrevClick}
          ></button>
          <button
            type="button"
            data-slide-to="1"
            className={activeIndex === 1 ? "active" : ""} onClick={handlePrevClick}
          ></button>
          <button
            type="button"
            data-slide-to="2"
            className={activeIndex === 2 ? "active" : ""} onClick={handlePrevClick}
          ></button>
        </div>
